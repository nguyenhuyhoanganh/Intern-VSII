...
public class UserConstant {
    ...
    public static String USER_MESSAGE_IS_NULL;
    public static String USER_NOT_FOUND_BY_USERNAME;
    ...
    public UserConstant(MessageSource messageSource) {
        ...
        USER_MESSAGE_IS_NULL = messageSource.getMessage("exception.user.id.not_valid", null, Locale.getDefault());
        USER_NOT_FOUND_BY_USERNAME = messageSource.getMessage("exception.user.not_found_by_username", null, Locale.getDefault());
    ...
    public static final String USER_MESSAGE_NOT_FOUND = "exception.user.not_found";
