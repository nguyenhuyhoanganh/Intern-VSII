...
//    public static final String ID_NOTVALID = "ID phải là số nguyên dương lớn hơn 0";
    ...
    public static final String DATE_OF_BIRTH_NOT_VALID = "Ngày sinh không hợp l hoặc có kiêu 'DD-MM-YYYY'";
